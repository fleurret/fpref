...
% bname2=currdirname(startidx(2):endidx(2));
...
% Burd1=dir(bname+"\2024_07_02\**\*.not.mat");
% 
% 
% Burd2=dir(bname2+"\2024_07_02\**\*.not.mat")
% 
...
for i=1:length(Burd1)
    savedir=Burd1(i).folder;
    disp(savedir)
    savedir=split(savedir,'\');
    savedir=savedir{end};
    fil1=Burd1(i).name;
    fil2=Burd2(i).name;
  %  fil1=split(fil1,'_');
...
%   if length(matchidx)==1 %strcmp(fil1{2},fil2{2}) % Then same file prefix. 
        ...
        pad=zeros(3*fs,1);
        rawaudiochannel2=bandpass(audiochannel2,fs,300,10000);
        rawaudiochannel1=bandpass(audiochannel1,fs2,300,10000);
