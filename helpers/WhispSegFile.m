...
options.min_segment_length=0.010 ;%min segment length in seconds (default: 0.005)
options.adobe_audition_compatible=0;
options.spec_time_step=0.0020   ;
% service_address="http://169.230.191.152:8058/segment";
%service_address="http://127.0.0.1:8050/segment";
% service_address='http://169.230.191.127:8056/segment';
service_address='http://169.230.191.127:8058/segment';
min_int=5;
min_dur=10;
sm_win=20;
threshold=1e-2;
