...
for i = 1:length(cages)
    ...
    plot(ax(i), [cage.JuvKDE'; cage.AdultKDE'], [1:length(cage.JuvKDE); 1:length(cage.JuvKDE)],...
        'Marker', 'none',...
        'Color', 'k',...
        'LineWidth', 1.5)

    scatter(ax(i), cage.JuvKDE, 1:length(cage.JuvKDE),...
        'Marker', 'o',...
        'MarkerFaceColor', [189,191,245]./255,...
        'MarkerEdgeColor', 'none',...
        'MarkerFaceAlpha', 1,...
        'SizeData', 80)
    
    scatter(ax(i), cage.AdultKDE, 1:length(cage.JuvKDE),...
        'Marker', 'o',...
        'MarkerFaceColor', [39,43,126]./255,...
        'MarkerEdgeColor', 'none',...
        'MarkerFaceAlpha', 1,...
        'SizeData', 80)
    
    jm = mean(cage.JuvKDE, 'omitnan');
    am = mean(cage.AdultKDE, 'omitnan');
